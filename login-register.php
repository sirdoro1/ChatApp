...
<div class="signup-form" id="signup">
    ...
    <form action="login.php" method="post" id="signinform">
		...
		<p class="hint-text hint-text-danger"><?php echo $msg; ?></p>
        <div class="form-group">
    ...
    <div class="text-center" style="margin-bottom:5px;"><div id="signupbtn">Register here <a>Sign Up</a></div><div id="signinbtn">If you have account already <a>Sign In</a></div></div>
